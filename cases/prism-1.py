...
class GivenHeightIsoscelesRightTrianglePrism(GeometricalCase):
    ...
    def solution(self):
        if self._cached_solution is None:
            ...
            current_obj.add_solution_step('Vertices D,E,F',[D,E,F,line_de,line_fd,line_ef,line_ab,line_bc,line_ca,line_eb,line_da,line_fc])
    ...
    def present_bad_solution(self):
        
        doc_model = Document(f'{self.__class__.__name__} solution_bad')
